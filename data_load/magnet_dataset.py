...
from data_load.reader_data import Reader_Data
class magnet_Dataset(Dataset):
    def __init__(self, root, frequency, Mtype, transform=None, data_num='Null',  set_num=1,data_std=False):
        ...
        self.out_side = []
        self.imgs ,self.lbls ,self.factor ,self.out_side,out_name = Reader_Data.get_total_data(root, self.data_num, self.frequency, self.model_type, self.set_num)
